...
def go_repositories():
    ...
    go_repository(
        name = "com_github_nmcapule_quadtree",
        importpath = "github.com/nmcapule/quadtree",
        sum = "h1:gbMx2nd5cyukYadNhOW9xNokbD8rQehip9cHqICN3sw=",
        version = "v0.0.0-20200621095702-75c2b3334d81",
    )
    go_repository(
